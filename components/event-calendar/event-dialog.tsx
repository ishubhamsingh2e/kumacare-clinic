...
import { eventColorNames, eventColors } from "./colors";
        ...
        <div className="grid gap-4 py-4">
          ...
          <fieldset className="space-y-4">
            ...
            <RadioGroup
              ...
              defaultValue={eventColorNames[0]}
              value={color}
              onValueChange={(value: EventColor) => setColor(value)}
            >
              {eventColorNames.map((colorName) => (
                <RadioGroupItem
                  key={colorName}
                  id={`color-${colorName}`}
                  value={colorName}
                  aria-label={colorName}
                  className="data-[state=checked]:border-foreground size-6"
                  style={
                    {
